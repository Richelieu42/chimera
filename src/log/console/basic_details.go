...
func printOsDetails(logger *zap.SugaredLogger) {
...
func printTimeDetails(logger *zap.SugaredLogger) {
...
func printMemoryDetails(logger *zap.SugaredLogger) {
...
func printDiskDetails(logger *zap.SugaredLogger) {
...
func printCpuDetails(logger *zap.SugaredLogger) {
