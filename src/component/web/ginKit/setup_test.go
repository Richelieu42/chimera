...
import (
	...
	proxyKit2 "github.com/richelieu-yang/chimera/v3/src/component/web/proxy/proxyKit"
...
func TestMustSetUp(t *testing.T) {
	...
	MustSetUp(c.Gin, func(engine *gin.Engine) error {
		...
		engine.Any("/test", func(ctx *gin.Context) {
			if err := proxyKit2.ProxyWithGin(ctx, target); err != nil {
				if !proxyKit2.IsNegligibleError(err) {
